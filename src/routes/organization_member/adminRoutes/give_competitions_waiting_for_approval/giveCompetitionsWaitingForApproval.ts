...
import { TGiveCompetitionsWaitingForApprovalBody } from "../../../../types/adminRoutes.js";

const giveCompetitionsWaitingForApproval: RequestHandler = async (
  req,
  res
) => {
  const {parsedData} = req.body as TGiveCompetitionsWaitingForApprovalBody;
